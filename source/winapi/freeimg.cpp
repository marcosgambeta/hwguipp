...
using FREEIMAGE_LOADFROMHANDLE = FIBITMAP *(WINAPI *)(FREE_IMAGE_FORMAT fif, FreeImageIO *io, fi_handle handle,
                                                      int flags);
...
{
  pGetwidth = reinterpret_cast<FREEIMAGE_GETWIDTH>(
      s_getFunction(reinterpret_cast<FARPROC>(pGetwidth), "_FreeImage_GetWidth@4"));
...
HB_FUNC(HWG_FI_2BITMAP)
{
  ...
  pGetbits =
      reinterpret_cast<FREEIMAGE_GETBITS>(s_getFunction(reinterpret_cast<FARPROC>(pGetbits), "_FreeImage_GetBits@4"));
  pGetinfo =
      reinterpret_cast<FREEIMAGE_GETINFO>(s_getFunction(reinterpret_cast<FARPROC>(pGetinfo), "_FreeImage_GetInfo@4"));
  pGetinfoHead = reinterpret_cast<FREEIMAGE_GETINFOHEADER>(
      s_getFunction(reinterpret_cast<FARPROC>(pGetinfoHead), "_FreeImage_GetInfoHeader@4"));

  hb_retnl(reinterpret_cast<LONG>(
      CreateDIBitmap(hDC, pGetinfoHead(dib), CBM_INIT, pGetbits(dib), pGetinfo(dib), DIB_RGB_COLORS)));
...
HB_FUNC(HWG_FI_FI2DIB)
{
  ...
  pGetBPP =
      reinterpret_cast<FREEIMAGE_GETBPP>(s_getFunction(reinterpret_cast<FARPROC>(pGetBPP), "_FreeImage_GetBPP@4"));
  pGetPitch =
      reinterpret_cast<FREEIMAGE_GETPITCH>(s_getFunction(reinterpret_cast<FARPROC>(pGetBPP), "_FreeImage_GetPitch@4"));
  pGetbits =
      reinterpret_cast<FREEIMAGE_GETBITS>(s_getFunction(reinterpret_cast<FARPROC>(pGetbits), "_FreeImage_GetBits@4"));
...
HB_FUNC(HWG_FI_FI2DIBEX)
{
  ...
  pGetColorsUsed = reinterpret_cast<FREEIMAGE_GETCOLORSUSED>(
      s_getFunction(reinterpret_cast<FARPROC>(pGetColorsUsed), "_FreeImage_GetColorsUsed@4"));
  pGetwidth = reinterpret_cast<FREEIMAGE_GETWIDTH>(
      s_getFunction(reinterpret_cast<FARPROC>(pGetwidth), "_FreeImage_GetWidth@4"));
  pGetheight = reinterpret_cast<FREEIMAGE_GETHEIGHT>(
      s_getFunction(reinterpret_cast<FARPROC>(pGetheight), "_FreeImage_GetHeight@4"));
  pGetBPP =
      reinterpret_cast<FREEIMAGE_GETBPP>(s_getFunction(reinterpret_cast<FARPROC>(pGetBPP), "_FreeImage_GetBPP@4"));
  pGetPitch = reinterpret_cast<FREEIMAGE_GETPITCH>(
      s_getFunction(reinterpret_cast<FARPROC>(pGetPitch), "_FreeImage_GetPitch@4"));
  pGetinfoHead = reinterpret_cast<FREEIMAGE_GETINFOHEADER>(
      s_getFunction(reinterpret_cast<FARPROC>(pGetinfoHead), "_FreeImage_GetInfoHeader@4"));
  pGetinfo =
      reinterpret_cast<FREEIMAGE_GETINFO>(s_getFunction(reinterpret_cast<FARPROC>(pGetinfo), "_FreeImage_GetInfo@4"));
  pGetbits =
      reinterpret_cast<FREEIMAGE_GETBITS>(s_getFunction(reinterpret_cast<FARPROC>(pGetbits), "_FreeImage_GetBits@4"));
  pGetPalette = reinterpret_cast<FREEIMAGE_GETPALETTE>(
      s_getFunction(reinterpret_cast<FARPROC>(pGetPalette), "_FreeImage_GetPalette@4"));
  pGetImageType = reinterpret_cast<FREEIMAGE_GETIMAGETYPE>(
      s_getFunction(reinterpret_cast<FARPROC>(pGetImageType), "_FreeImage_GetImageType@4"));
...
HB_FUNC(HWG_FI_BMP2FI)
{
  ...
  if (hbmp)
  {
    ...
    pAllocate = reinterpret_cast<FREEIMAGE_ALLOCATE>(
        s_getFunction(reinterpret_cast<FARPROC>(pAllocate), "_FreeImage_Allocate@24"));
    pGetbits =
        reinterpret_cast<FREEIMAGE_GETBITS>(s_getFunction(reinterpret_cast<FARPROC>(pGetbits), "_FreeImage_GetBits@4"));
    pGetinfo =
        reinterpret_cast<FREEIMAGE_GETINFO>(s_getFunction(reinterpret_cast<FARPROC>(pGetinfo), "_FreeImage_GetInfo@4"));
...
HB_FUNC(HWG_FI_DIB2FI)
{
  ...
  if (hdib)
  {
    ...
    pConvertFromRawBits = reinterpret_cast<FREEIMAGE_CONVERTFROMRAWBITS>(
        s_getFunction(reinterpret_cast<FARPROC>(pConvertFromRawBits), "_FreeImage_ConvertFromRawBits@36"));
    pGetPalette = reinterpret_cast<FREEIMAGE_GETPALETTE>(
        s_getFunction(reinterpret_cast<FARPROC>(pGetPalette), "_FreeImage_GetPalette@4"));
    pGetBPP =
        reinterpret_cast<FREEIMAGE_GETBPP>(s_getFunction(reinterpret_cast<FARPROC>(pGetBPP), "_FreeImage_GetBPP@4"));
...
{
  pRescale =
      reinterpret_cast<FREEIMAGE_RESCALE>(s_getFunction(reinterpret_cast<FARPROC>(pRescale), "_FreeImage_Rescale@16"));

  hb_retnl(pRescale ? reinterpret_cast<LONG>(pRescale(hwg_par_FIBITMAP(1), hb_parnl(2), hb_parnl(3),
                                                      static_cast<FREE_IMAGE_FILTER>(hb_parni(4))))
                    : 0);
}
...
HB_FUNC(HWG_FI_REMOVECHANNEL)
{
  ...
  pGetheight = reinterpret_cast<FREEIMAGE_GETHEIGHT>(
      s_getFunction(reinterpret_cast<FARPROC>(pGetheight), "_FreeImage_GetHeight@4"));
  pSetChannel = reinterpret_cast<FREEIMAGE_SETCHANNEL>(
      s_getFunction(reinterpret_cast<FARPROC>(pSetChannel), "_FreeImage_SetChannel@12"));
  pUnload =
      reinterpret_cast<FREEIMAGE_UNLOAD>(s_getFunction(reinterpret_cast<FARPROC>(pUnload), "_FreeImage_Unload@4"));
...
{
  pRotateClassic = reinterpret_cast<FREEIMAGE_ROTATECLASSIC>(
      s_getFunction(reinterpret_cast<FARPROC>(pRotateClassic), "_FreeImage_RotateClassic@12"));
...
{
  pGetDotsPerMeterX = reinterpret_cast<FREEIMAGE_GETDOTSPERMETERX>(
      s_getFunction(reinterpret_cast<FARPROC>(pGetDotsPerMeterX), "_FreeImage_GetDotsPerMeterX@4"));
...
{
  pGetDotsPerMeterY = reinterpret_cast<FREEIMAGE_GETDOTSPERMETERY>(
      s_getFunction(reinterpret_cast<FARPROC>(pGetDotsPerMeterY), "_FreeImage_GetDotsPerMeterY@4"));
...
HB_FUNC(HWG_FI_SETBACKGROUNDCOLOR)
{
  ...
  pSetBackgroundColor = reinterpret_cast<FREEIMAGE_SETBACKGROUNDCOLOR>(
      s_getFunction(reinterpret_cast<FARPROC>(pSetBackgroundColor), "_FreeImage_SetBackgroundColor@8"));
...
{
  pInvert =
      reinterpret_cast<FREEIMAGE_INVERT>(s_getFunction(reinterpret_cast<FARPROC>(pInvert), "_FreeImage_Invert@4"));
...
{
  pConvertTo8Bits = reinterpret_cast<FREEIMAGE_CONVERTTO8BITS>(
      s_getFunction(reinterpret_cast<FARPROC>(pConvertTo8Bits), "_FreeImage_ConvertTo8Bits@4"));
...
{
  pConvertToGreyscale = reinterpret_cast<FREEIMAGE_CONVERTTOGREYSCALE>(
      s_getFunction(reinterpret_cast<FARPROC>(pConvertToGreyscale), "_FreeImage_ConvertToGreyscale@4"));
...
{
  pThreshold = reinterpret_cast<FREEIMAGE_THRESHOLD>(
      s_getFunction(reinterpret_cast<FARPROC>(pThreshold), "_FreeImage_Threshold@8"));
...
{
  pFlipVertical = reinterpret_cast<FREEIMAGE_FLIPVERTICAL>(
      s_getFunction(reinterpret_cast<FARPROC>(pFlipVertical), "_FreeImage_FlipVertical@4"));
...
HB_FUNC(HWG_FI_GETPIXELINDEX)
{
  ...
  pGetPixelIndex = reinterpret_cast<FREEIMAGE_GETPIXELINDEX>(
      s_getFunction(reinterpret_cast<FARPROC>(pGetPixelIndex), "_FreeImage_GetPixelIndex@16"));
...
HB_FUNC(HWG_FI_SETPIXELINDEX)
{
  ...
  pSetPixelIndex = reinterpret_cast<FREEIMAGE_SETPIXELINDEX>(
      s_getFunction(reinterpret_cast<FARPROC>(pSetPixelIndex), "_FreeImage_SetPixelIndex@16"));
