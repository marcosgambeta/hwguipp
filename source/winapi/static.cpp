...
HB_FUNC(HWG_CREATESTATIC)
{
  ...
  auto hWndCtrl =
      CreateWindowEx(ulExStyle, TEXT("STATIC"), nullptr, WS_CHILD | WS_VISIBLE | ulStyle, hwg_par_int(4),
...
{
  wpOrigStaticProc = reinterpret_cast<WNDPROC>(
      SetWindowLongPtr(hwg_par_HWND(1), GWLP_WNDPROC, reinterpret_cast<LONG_PTR>(StaticSubclassProc)));
}
