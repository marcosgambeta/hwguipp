...
HB_FUNC( HWG_MCISENDSTRING )
{
   ...
   hb_retnl(static_cast<LONG>(mciSendString(HB_PARSTR(1, &hCommand, nullptr), cBuffer, HB_SIZEOFARRAY(cBuffer), HB_ISNIL(3) ? GetActiveWindow() : static_cast<HWND>(HB_PARHANDLE(3)))));
