...
HB_FUNC(HWG_SELECTFILE)
{
  ...
  else if (HB_ISARRAY(1) && HB_ISARRAY(2))
  {
    ...
    auto pArr1 = hb_param(1, Harbour::Item::ARRAY);
    auto pArr2 = hb_param(2, Harbour::Item::ARRAY);
...
HB_FUNC(HWG_WRITEPRIVATEPROFILESTRING)
{
  ...
  hb_retl(WritePrivateProfileString(HB_PARSTR(1, &hSection, nullptr), HB_PARSTR(2, &hEntry, nullptr),
