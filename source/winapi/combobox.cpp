...
{
  auto hCombo = CreateWindowEx(0, TEXT("COMBOBOX"), TEXT(""), WS_CHILD | WS_VISIBLE | hwg_par_DWORD(3), hwg_par_int(4),
...
{
  hb_retnl(SendMessage(hwg_par_HWND(1), CB_SETITEMDATA, hb_parnl(2),
                       static_cast<LPARAM>(static_cast<DWORD_PTR>(hb_parnl(3)))));
}
