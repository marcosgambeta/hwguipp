...
HB_FUNC(HWG_CREATETOOLBAR)
{
  ...
  auto hWndCtrl =
      CreateWindowEx(ulExStyle, TOOLBARCLASSNAME, nullptr,
                     WS_CHILD | WS_OVERLAPPED | WS_VISIBLE | TBSTYLE_ALTDRAG | TBSTYLE_TOOLTIPS | TBSTYLE_WRAPABLE |
                         CCS_TOP | CCS_NORESIZE | ulStyle,
