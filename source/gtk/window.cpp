...
HB_FUNC(HWG_INITMAINWINDOW)
{
  ...
  /* Icon */
  PHWGUI_PIXBUF szFile = HB_ISPOINTER(5) ? static_cast<PHWGUI_PIXBUF>(hb_parptr(5)) : nullptr;
  /* Background image */
  PHWGUI_PIXBUF szBackFile = HB_ISPOINTER(11) ? static_cast<PHWGUI_PIXBUF>(hb_parptr(11)) : nullptr;
  ...
  gtk_widget_add_events(hWnd,
                        GDK_BUTTON_PRESS_MASK | GDK_BUTTON_RELEASE_MASK | GDK_POINTER_MOTION_MASK | GDK_FOCUS_CHANGE);
...
{
  gpointer gObject =
      g_object_get_data(reinterpret_cast<GObject *>(gtk_widget_get_parent(gtk_widget_get_parent(widget))), "obj");
...
static HB_LONG ToKey(HB_LONG a, HB_LONG b)
{
  ...
  case GDK_KEY_dead_tilde:
    ...
    case GDK_KEY_a:
      return static_cast<HB_LONG>(GDK_KEY_atilde);
    case GDK_KEY_N:
      return static_cast<HB_LONG>(GDK_KEY_Ntilde);
    case GDK_KEY_n:
      return static_cast<HB_LONG>(GDK_KEY_ntilde);
    case GDK_KEY_O:
      return static_cast<HB_LONG>(GDK_KEY_Otilde);
    case GDK_KEY_o:
      return static_cast<HB_LONG>(GDK_KEY_otilde);
    }
    break;
  ...
  case GDK_KEY_dead_circumflex:
    ...
    case GDK_KEY_a:
      return static_cast<HB_LONG>(GDK_KEY_acircumflex);
    case GDK_KEY_E:
      return static_cast<HB_LONG>(GDK_KEY_Ecircumflex);
    case GDK_KEY_e:
      return static_cast<HB_LONG>(GDK_KEY_ecircumflex);
    case GDK_KEY_I:
      return static_cast<HB_LONG>(GDK_KEY_Icircumflex);
    case GDK_KEY_i:
      return static_cast<HB_LONG>(GDK_KEY_icircumflex);
    case GDK_KEY_O:
      return static_cast<HB_LONG>(GDK_KEY_Ocircumflex);
    case GDK_KEY_o:
      return static_cast<HB_LONG>(GDK_KEY_ocircumflex);
    case GDK_KEY_U:
      return static_cast<HB_LONG>(GDK_KEY_Ucircumflex);
    case GDK_KEY_u:
      return static_cast<HB_LONG>(GDK_KEY_ucircumflex);
    case GDK_KEY_C:
      return static_cast<HB_LONG>(GDK_KEY_Ccircumflex);
    case GDK_KEY_H:
      return static_cast<HB_LONG>(GDK_KEY_Hcircumflex);
    case GDK_KEY_h:
      return static_cast<HB_LONG>(GDK_KEY_hcircumflex);
    case GDK_KEY_J:
      return static_cast<HB_LONG>(GDK_KEY_Jcircumflex);
    case GDK_KEY_j:
      return static_cast<HB_LONG>(GDK_KEY_jcircumflex);
    case GDK_KEY_G:
      return static_cast<HB_LONG>(GDK_KEY_Gcircumflex);
    case GDK_KEY_g:
      return static_cast<HB_LONG>(GDK_KEY_gcircumflex);
    case GDK_KEY_S:
      return static_cast<HB_LONG>(GDK_KEY_Scircumflex);
    case GDK_KEY_s:
      return static_cast<HB_LONG>(GDK_KEY_scircumflex);
    }
    break;
  ...
  case GDK_KEY_dead_grave:
    ...
    case GDK_KEY_a:
      return static_cast<HB_LONG>(GDK_KEY_agrave);
    case GDK_KEY_E:
      return static_cast<HB_LONG>(GDK_KEY_Egrave);
    case GDK_KEY_e:
      return static_cast<HB_LONG>(GDK_KEY_egrave);
    case GDK_KEY_I:
      return static_cast<HB_LONG>(GDK_KEY_Igrave);
    case GDK_KEY_i:
      return static_cast<HB_LONG>(GDK_KEY_igrave);
    case GDK_KEY_O:
      return static_cast<HB_LONG>(GDK_KEY_Ograve);
    case GDK_KEY_o:
      return static_cast<HB_LONG>(GDK_KEY_ograve);
    case GDK_KEY_U:
      return static_cast<HB_LONG>(GDK_KEY_Ugrave);
    case GDK_KEY_u:
      return static_cast<HB_LONG>(GDK_KEY_ugrave);
    case GDK_KEY_C:
      return static_cast<HB_LONG>(GDK_KEY_Ccedilla);
    case GDK_KEY_c:
      return static_cast<HB_LONG>(GDK_KEY_ccedilla);
    }
    break;
  ...
  case GDK_KEY_dead_acute:
    ...
    case GDK_KEY_a:
      return static_cast<HB_LONG>(GDK_KEY_aacute);
    case GDK_KEY_E:
      return static_cast<HB_LONG>(GDK_KEY_Eacute);
    case GDK_KEY_e:
      return static_cast<HB_LONG>(GDK_KEY_eacute);
    case GDK_KEY_I:
      return static_cast<HB_LONG>(GDK_KEY_Iacute);
    case GDK_KEY_i:
      return static_cast<HB_LONG>(GDK_KEY_iacute);
    case GDK_KEY_O:
      return static_cast<HB_LONG>(GDK_KEY_Oacute);
    case GDK_KEY_o:
      return static_cast<HB_LONG>(GDK_KEY_oacute);
    case GDK_KEY_U:
      return static_cast<HB_LONG>(GDK_KEY_Uacute);
    case GDK_KEY_u:
      return static_cast<HB_LONG>(GDK_KEY_uacute);
    case GDK_KEY_Y:
      return static_cast<HB_LONG>(GDK_KEY_Yacute);
    case GDK_KEY_y:
      return static_cast<HB_LONG>(GDK_KEY_yacute);
    case GDK_KEY_C:
      return static_cast<HB_LONG>(GDK_KEY_Cacute);
    case GDK_KEY_c:
      return static_cast<HB_LONG>(GDK_KEY_cacute);
    case GDK_KEY_L:
      return static_cast<HB_LONG>(GDK_KEY_Lacute);
    case GDK_KEY_l:
      return static_cast<HB_LONG>(GDK_KEY_lacute);
    case GDK_KEY_N:
      return static_cast<HB_LONG>(GDK_KEY_Nacute);
    case GDK_KEY_n:
      return static_cast<HB_LONG>(GDK_KEY_nacute);
    case GDK_KEY_R:
      return static_cast<HB_LONG>(GDK_KEY_Racute);
    case GDK_KEY_r:
      return static_cast<HB_LONG>(GDK_KEY_racute);
    case GDK_KEY_S:
      return static_cast<HB_LONG>(GDK_KEY_Sacute);
    case GDK_KEY_s:
      return static_cast<HB_LONG>(GDK_KEY_sacute);
    case GDK_KEY_Z:
      return static_cast<HB_LONG>(GDK_KEY_Zacute);
    case GDK_KEY_z:
      return static_cast<HB_LONG>(GDK_KEY_zacute);
    }
    break;
  ...
  case GDK_KEY_dead_diaeresis:
    ...
    case GDK_KEY_a:
      return static_cast<HB_LONG>(GDK_KEY_adiaeresis);
    case GDK_KEY_E:
      return static_cast<HB_LONG>(GDK_KEY_Ediaeresis);
    case GDK_KEY_e:
      return static_cast<HB_LONG>(GDK_KEY_ediaeresis);
    case GDK_KEY_I:
      return static_cast<HB_LONG>(GDK_KEY_Idiaeresis);
    case GDK_KEY_i:
      return static_cast<HB_LONG>(GDK_KEY_idiaeresis);
    case GDK_KEY_O:
      return static_cast<HB_LONG>(GDK_KEY_Odiaeresis);
    case GDK_KEY_o:
      return static_cast<HB_LONG>(GDK_KEY_odiaeresis);
    case GDK_KEY_U:
      return static_cast<HB_LONG>(GDK_KEY_Udiaeresis);
    case GDK_KEY_u:
      return static_cast<HB_LONG>(GDK_KEY_udiaeresis);
    case GDK_KEY_Y:
      return static_cast<HB_LONG>(GDK_KEY_Ydiaeresis);
    case GDK_KEY_y:
      return static_cast<HB_LONG>(GDK_KEY_ydiaeresis);
    }
  }
...
static gint cb_event(GtkWidget *widget, GdkEvent *event, gchar *data)
{
  ...
  if (pSym_onEvent && gObject) {
    ...
    case GDK_BUTTON_RELEASE: {
      ...
      p2 = 0;
      p3 = ((static_cast<HB_ULONG>((reinterpret_cast<GdkEventButton *>(event))->x)) & 0xFFFF) |
           (((static_cast<HB_ULONG>((reinterpret_cast<GdkEventButton *>(event))->y)) << 16) & 0xFFFF0000);
      break;
    }
    case GDK_MOTION_NOTIFY: {
      p1 = WM_MOUSEMOVE;
      p2 = ((reinterpret_cast<GdkEventMotion *>(event))->state & GDK_BUTTON1_MASK) ? 1 : 0;
      p3 = ((static_cast<HB_ULONG>((reinterpret_cast<GdkEventMotion *>(event))->x)) & 0xFFFF) |
           (((static_cast<HB_ULONG>((reinterpret_cast<GdkEventMotion *>(event))->y)) << 16) & 0xFFFF0000);
      break;
    }
    case GDK_CONFIGURE: {
      GtkAllocation alloc;
    ...
    case GDK_LEAVE_NOTIFY: {
      p1 = WM_MOUSEMOVE;
      p2 = ((reinterpret_cast<GdkEventCrossing *>(event))->state & GDK_BUTTON1_MASK) ? 1
           : 0 | (event->type == GDK_ENTER_NOTIFY)                                   ? 0x10
                                                                                     : 0;
      p3 = ((static_cast<HB_ULONG>((reinterpret_cast<GdkEventCrossing *>(event))->x)) & 0xFFFF) |
           (((static_cast<HB_ULONG>((reinterpret_cast<GdkEventMotion *>(event))->y)) << 16) & 0xFFFF0000);
      break;
    }
...
{
  auto p = static_cast<gpointer>(hb_parptr(1));
  set_signal(static_cast<gpointer>(p), hb_parc(2), hb_parnl(3), hb_parnl(4), reinterpret_cast<long int>(hb_parptr(5)));
}

HB_FUNC(HWG_EMITSIGNAL)
{
  g_signal_emit_by_name(G_OBJECT(hb_parptr(1)), const_cast<char *>(hb_parc(2)));
}
...
{
  SetWindowObject(static_cast<GtkWidget *>(hb_parptr(1)), hb_param(2, Harbour::Item::OBJECT));
}
...
HB_FUNC(HWG_SETWINDOWTEXT)
{
  ...
  gtk_window_set_title(GTK_WINDOW(hb_parptr(1)), gcTitle);
  g_free(gcTitle);
}

HB_FUNC(HWG_GETWINDOWTEXT)
{
  char *cTitle = const_cast<char *>(gtk_window_get_title(GTK_WINDOW(hb_parptr(1))));
  hb_retc(cTitle);
}
...
{
  auto hWnd = static_cast<GtkWindow *>(hb_parptr(1));
...
{
  gtk_window_maximize(static_cast<GtkWindow *>(hb_parptr(1)));
}

HB_FUNC(HWG_RESTOREWINDOW)
{
  gtk_window_unmaximize(static_cast<GtkWindow *>(hb_parptr(1)));
}

HB_FUNC(HWG_WINDOWMINIMIZE)
{
  gtk_window_iconify(static_cast<GtkWindow *>(hb_parptr(1)));
}
...
void SetObjectVar(PHB_ITEM pObject, const char *varname,
                  PHB_ITEM pValue) // TODO: deprecate and call hb_objSendMsg directly
{
...
{
  gtk_widget_destroy(static_cast<GtkWidget *>(hb_parptr(1)));
}
...
{
  hwg_set_modal(static_cast<GtkWindow *>(hb_parptr(1)),
                static_cast<GtkWindow *>((!HB_ISNIL(2)) ? hb_parptr(2) : nullptr));
}

HB_FUNC(HWG_WINDOWSETRESIZE)
{
  auto handle = static_cast<GtkWindow *>(hb_parptr(1));
...
{
  gtk_window_set_keep_above(static_cast<GtkWindow *>(hb_parptr(1)), TRUE);
}

HB_FUNC(HWG_REMOVETOPMOST)
{
  gtk_window_set_keep_above(static_cast<GtkWindow *>(hb_parptr(1)), FALSE);
}
...
HB_FUNC(HWG_GETWINDOWPOS)
{
  ...
  gtk_window_get_position(static_cast<GtkWindow *>(hb_parptr(1)), &x, &y);
...
{
  gtk_test_widget_send_key(static_cast<GtkWidget *>(hb_parptr(1)), static_cast<guint>(hb_parni(2)),
                           static_cast<GdkModifierType>(hb_parni(3)));
}
...
{
  gtk_window_deiconify(static_cast<GtkWindow *>(hb_parptr(1)));
}
...
HB_FUNC( HWG_SHELLMODIFYICON )
{
   ...
   if( szFile ) {
      gtk_window_set_icon(static_cast<GtkWindow*>(hb_parptr(1)), szFile->handle);
      gtk_window_set_default_icon(szFile->handle);
      gtk_window_iconify(static_cast<GtkWindow*>(hb_parptr(1)));
      gtk_window_deiconify(static_cast<GtkWindow*>(hb_parptr(1)));
   }
