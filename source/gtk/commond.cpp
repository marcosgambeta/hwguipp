...
{
  auto szFontName =
      static_cast<char *>(gtk_font_selection_dialog_get_font_name(static_cast<GtkFontSelectionDialog *>(fontseldlg)));
...
HB_FUNC(HWG_SELECTFONT)
{
  ...
  g_signal_connect_swapped(
      G_OBJECT(gtk_font_selection_dialog_get_ok_button(reinterpret_cast<GtkFontSelectionDialog *>(fontseldlg))),
  ...
  g_signal_connect_swapped(
      G_OBJECT(gtk_font_selection_dialog_get_cancel_button(reinterpret_cast<GtkFontSelectionDialog *>(fontseldlg))),
...
HB_FUNC(HWG_SELECTFILE)
{
  ...
  g_signal_connect_swapped(G_OBJECT(GTK_FILE_SELECTION(file_selector)->ok_button), "clicked",
                           G_CALLBACK(store_filename), static_cast<gpointer>(file_selector));
...
HB_FUNC(HWG_SELECTFILE)
{
  ...
  gtk_file_chooser_set_preview_widget(static_cast<GtkFileChooser *>(selector_archivo),
                                      static_cast<GtkWidget *>(preview));
...
void store_color(gpointer colorseldlg)
{
  ...
  colorsel = GTK_COLOR_SELECTION(
      gtk_color_selection_dialog_get_color_selection(static_cast<GtkColorSelectionDialog *>(colorseldlg)));
...
HB_FUNC(HWG_CHOOSECOLOR)
{
  ...
  /*
     ...
     G_CALLBACK(store_color), static_cast<gpointer>(colorseldlg));

     g_signal_connect_swapped(GTK_OBJECT(GTK_COLOR_SELECTION_DIALOG(colorseldlg)->cancel_button), "clicked",
     G_CALLBACK(gtk_widget_destroy), static_cast<gpointer>(colorseldlg));
...
HB_FUNC(HWG_SELECTFILEEX)
{
  ...
  selector_archivo = gtk_file_chooser_dialog_new(cTitle, reinterpret_cast<GtkWindow *>(GetActiveWindow()),
                                                 ...
                                                 "gtk-open", GTK_RESPONSE_ACCEPT, nullptr);
  ...
  gtk_file_chooser_set_preview_widget(reinterpret_cast<GtkFileChooser *>(selector_archivo),
                                      reinterpret_cast<GtkWidget *>(preview));
...
HB_FUNC(HWG_SELECTFOLDER)
{
  ...
  selector_archivo = gtk_file_chooser_dialog_new(cTitle, reinterpret_cast<GtkWindow *>(GetActiveWindow()),
                                                 ...
                                                 GTK_RESPONSE_CANCEL, "gtk-open", GTK_RESPONSE_ACCEPT, nullptr);
