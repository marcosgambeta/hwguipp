...
CLASS HMonthCalendar INHERIT HControl
   ...
   METHOD New(oWndParent, nId, vari, nStyle, nX, nY, nWidth, nHeight, oFont, bInit, bChange, cTooltip, lNoToday, lNoTodayCircle, lWeekNumbers)
   METHOD Activate()
   METHOD Init()
...
// Windows only DATEPICKER command
   ...
   @ 0, 0 MONTHCALENDAR oMC SIZE wid - 1, hei - 1 INIT dstartdate /* Date(), if NIL */ FONT oFont
